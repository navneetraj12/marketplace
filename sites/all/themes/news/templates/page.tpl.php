...
global $base_url;
 if($user->uid) {
	$login_text = '<a href="'.$base_url.'/user/'.$user->uid.'">My Account</a> | <a href="'.$base_url.'/user/logout">Logout</a>';
 }
 else {
	 $login_text = '<a href="'.$base_url.'/user/login">Login</a> | <a href="'.$base_url.'/seller/register">Register as Seller</a>  | <a href="'.$base_url.'/buyer/register">Register as Buyer</a>';
 }
?>
<div id="page-wrapper">
      <!-- !Leaderboard Region -->
	      ...
	      <div id="block-block-13" class="block block-block no-title">
			<div class="block-inner clearfix">  
				<div class="block-content content">
					<div class="column1"><a class="fb" href="javascript:void(0);" target="_blank" title="Facebook">facebook</a><a class="tw" href="javascript:void(0);" target="_blank" title="Twitter">Twitter</a></div>
					
					<div class="column3"><?php echo $login_text;?></div>
				</div>
			</div>
		</div>
	</div>
        ...
        <div<?php print $branding_attributes; ?>>
          ...
          <?php if ($site_logo): ?>
		   <div id ="log-wrapper">
			...
			<div id="header_banner_728"><?php print render($page['header_banner']); ?></div>
			<?php endif; ?>
			<!-- Right side ad-->
		  </div>
          <?php endif; ?>
